...
jupyter:
  ...
  nbformat: 4
  nbformat_minor: 0
title: "Advanced Machine Learning Nonparametric Models"
...
::: {.cell .code execution_count="1" id="bns5jPn7JYbr"}
``` {.python}
...
::: {.cell .code execution_count="2" id="uvJcOKMAJj06"}
``` {.python}
...
::: {.cell .code execution_count="3" colab="{\"base_uri\":\"https://localhost:8080/\"}" id="u3GWUujIJj7q" outputId="f2a72f47-769c-49af-ae93-11e909a8b30c"}
``` {.python}
# Mount Google Drive
...
::: {.cell .code execution_count="4" colab="{\"height\":270,\"base_uri\":\"https://localhost:8080/\"}" id="olrWr0sdK938" outputId="92dbb97e-c82f-4889-d09a-4d5ba6341c0c"}
``` {.python}
# Load data
...
::: {.cell .code execution_count="5" colab="{\"height\":848,\"base_uri\":\"https://localhost:8080/\"}" id="G5yYLOaoK9-H" outputId="521f217d-94bb-4e7b-ffad-6a5573fae12a"}
``` {.python}
...
::: {.output .display_data}
![](vertopal_6e0007f1f328436d9eb51fc35ed4e324/897c6d9f98a7d44f9c52e5714af2b5ec8efd9aeb.png){height="831"
width="1018"}
:::
:::
...
::: {.cell .code execution_count="6" id="tzNINy57KNJh"}
``` {.python}
...
::: {.cell .code execution_count="21" id="RxGHIr6NKNPX"}
``` {.python}
...
::: {.cell .code execution_count="9" id="_5hsyq4WW5pU"}
``` {.python}
# Linear model
...
::: {.cell .code execution_count="34" colab="{\"height\":475,\"base_uri\":\"https://localhost:8080/\"}" id="DscSdOTTYGTO" outputId="6425cbb3-f5e7-48f6-b5ef-725ca73ff2dd"}
``` {.python}
...
::: {.output .display_data}
![](vertopal_6e0007f1f328436d9eb51fc35ed4e324/17e01b41a295c12b5d1a30fb3f18de079101befe.png){height="440"
width="614"}
:::
...
::: {.cell .code execution_count="33" colab="{\"height\":492,\"base_uri\":\"https://localhost:8080/\"}" id="VnZL6WoNYK6E" outputId="79787906-8993-413a-a566-5c603a810f6c"}
``` {.python}
# Random Forest Regression
...
::: {.output .display_data}
![](vertopal_6e0007f1f328436d9eb51fc35ed4e324/5cdd4ede4688647935aed9ee29835156133fb2cd.png){height="440"
width="614"}
:::
...
::: {.cell .code execution_count="26" id="ucrC__W2KM7a"}
``` {.python}
# Define kernels
...
::: {.cell .code execution_count="25" id="zuPzMGxlK9kd"}
``` {.python}
# Smoother model
...
::: {.cell .code execution_count="35" colab="{\"height\":492,\"base_uri\":\"https://localhost:8080/\"}" id="2MM-g0RMMUDV" outputId="2b23e1ac-480a-4911-9809-26e93152018c"}
``` {.python}
...
::: {.output .display_data}
![](vertopal_6e0007f1f328436d9eb51fc35ed4e324/2bab8b51b417cd27daa8fee0767be6ae0cdfcbbd.png){height="440"
width="614"}
:::
...
::: {.cell .code execution_count="28" colab="{\"height\":492,\"base_uri\":\"https://localhost:8080/\"}" id="ZarY-skm11Lz" outputId="1bbdd451-c640-4354-fe82-a481da98695f"}
``` {.python}
# Locally Weighted Regression
...
::: {.output .display_data}
![](vertopal_6e0007f1f328436d9eb51fc35ed4e324/47bbb7ee53b9b0519bc260c3049f03cc7cfbf811.png){height="440"
width="614"}
:::
...
::: {.cell .code execution_count="29" colab="{\"height\":492,\"base_uri\":\"https://localhost:8080/\"}" id="KoM_I-tY11am" outputId="b8079997-7dc6-4836-a6d4-39c2bd8e6671"}
``` {.python}
# Locally Weighted Regression
...
::: {.output .display_data}
![](vertopal_6e0007f1f328436d9eb51fc35ed4e324/7b2e1005f8f1d70ff30e2e2712c0e807c98900f2.png){height="440"
width="614"}
:::
